...
#define STS_NORMAL					0
#define STS_BLUETOOTH_DISCONNECT    -1
...
@property (nonatomic) int logoType; // Added in 1.84


- (long) openPort:(NSString*)portName withPortParam:(int) port;
- (long) reopenPort:(NSString*)portName withPortParam:(int) port;//by seok
- (long) closePort;
...
// Added in 1.76b for web
- (long) printNormalWeb:(NSString *) normalData;
// Added in 1.77b for font
...
// Added in 1.81b for dithering
- (long) setDithering:(int) iDither;
// Added in 1.84b for OLE POS Command
...
- (long) setAbsoluteHorizontal:(int) absolutePosition;
...
- (long) checkStatus;    //by seok 19.08.14
- (void) recvBTConnection;  //by seok 19.08.14

// Wi-Fi only.
// Added in 1.81b to get/set printer's info.
