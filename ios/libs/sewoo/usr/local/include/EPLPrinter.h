...
#define LK_EPL_STS_COVER_OPEN            1
#define LK_EPL_STS_PAPER_EMPTY           2
#define LK_EPL_STS_RIBBON_EMPTY          4
#define LK_EPL_STS_PAPER_JAM             8
#define LK_EPL_STS_PAPER_MISMATCH        16
#define LK_EPL_STS_BUFFER_FULL           128
#define LK_EPL_STS_TIMEOUT               -1
...
- (long) setupPrinter:(NSString *) LabelWidth withHeight:(NSString *) LabelHeight withMedia:(int) MediaType withGapHeight:(NSString *) GapHeight
	withOffset:(NSString *) Offset withDensity:(int) Density withSpeed:(int) Speed withRotate180:(int) Rotate180 withCutMode:(int) CutMode; //by seok 200214 added cut_mode
...
- (long) checkBufferFull; //only Wi-Fi, not using Bluetooth
